...
$string['admin_host'] = 'Host API URL';
$string['admin_host_desc'] = "This is the URL where REST calls are sent to and it must bet set to the domain where our ACP server exists. If your ACP server is behind the domain name of myacpserver.com, then this settings would look like myacpserver.com/api/xml. The /api/xml part will always come after your server domain name unless your ACP server is customized to use a different location";
$string['admin_meethost'] = 'Meetinghost URL';
$string['admin_meethost_desc'] = "This value is just the domain name of your ACP server. The value would be the same as the Host setting above without the /api/xml part.";
$string['admin_port'] = 'Port';
$string['admin_port_desc'] = "The port your ACP server uses for it's connections. On some dedicated servers, the server admin may choose to run the Connect Pro service on a different port rather than run it on the standard 80 port.";
$string['admin_login'] = 'Admin Login';
$string['admin_login_desc'] = 'This is the super administrator account user name. This account will be user to make all the API calls and should have the permission to create users and assign roles. Create/update/delete meetings and move content (Meeting recordings) to shared folders on the Adobe Connect Pro server. If you are not sure which user account that is then you will have to contact your ACP server administrator and consult with them.';
$string['admin_password'] = 'Admin password';
$string['admin_password_desc'] = "The admin password for the Adobe Connect admin login";
$string['admin_key'] = 'API Key';
$string['admin_key_desc'] = "The security credential used to authenticate the connection between your Moodle site and your Adobe Connect server.";
$string['admin_hostgroupid'] = 'Host group Id';
$string['admin_hostgroupid_desc'] = "The group Id for Hosts in Adobe Connect. You can find this under `/api/xml?action=principal-list` and look for 'Meeting Hosts' with `type='live-admins'`.";
...
$string['autodelete_rooms'] = 'Auto delete rooms';
$string['autodelete_rooms_desc'] = "This will automatically delete rooms from the Adobe server when they're deleted in Moodle.";
...
$string['timeout_desc'] = 'Time in milliseconds before the connection to Adobe Connect is considered dead';
...
$string['myacpass'] = 'Set your Adobe Connect password:';
$string['respass'] = 'Generate random password';
$string['resetwarning'] = 'This will reset and replace your Adobe Connect password with a randomly generated one to assure that Single Sign On will work.';
$string['resetdont'] = 'Do not proceed if you know your password!';
$string['login_type'] = 'Login type';
$string['login_type_desc'] = 'Select the login type';
$string['meetingurlexists'] = 'This meeting url is already taken and has id ';
$string['setpass'] = 'Adobe Connect password';
$string['resetpass'] = 'Reset Adobe Connect password';
$string['onlyforexplain'] = 'Only for users that know their Adobe Connect password!';
$string['login_type_getparams'] = "Get parameters";
$string['login_type_httpauth'] = "Http authentication";
$string['couldnoterror'] = "Could not log you in automatically! Login manually or as guest!";
$string['nocapability'] = "You don't have the permission to do this!";
